...
SigmaCB() 
{
  ...
  ifstream outputs("histolines.txt");
  ...
  TH1F *Overlay1 = new TH1F ("Electron Cuts", "", 3, 0, 4);
  FillHistogram(Overlay1, w1, 1.0);
  FillHistogram(Overlay1, w2, 2.0);
  FillHistogram(Overlay1, w3, 3.0);
  Overlay1->GetXaxis()->SetBinLabel(1,"Tight");
  Overlay1->GetXaxis()->SetBinLabel(2,"MVA");
  Overlay1->GetXaxis()->SetBinLabel(3,"MVA + Tight");
  Overlay1->GetXaxis()->SetLabelSize(0.05);
  Overlay1->GetYaxis()->SetLabelSize(0.04);
  max = atof(axeslines[i].c_str());
  Overlay1->GetYaxis()->SetRangeUser(0.0, max); 

  TH1F *Overlays = new TH1F ("Electron Cuts", "", 3, 0, 4);
  ...
  Overlays2->GetYaxis()->SetRangeUser(0.0, max);
 
  Overlays2->SetBarWidth(0.2);
  Overlay1->SetBarWidth(0.2);

  Overlay1->GetXaxis()->SetTitle("Electron ID Cuts");
  Overlay1->GetXaxis()->SetTitleSize(0.05);
  Overlay1->GetYaxis()->SetTitle("Sigma_{CB} (GeV)/c^{2}");
  Overlay1->GetYaxis()->SetTitleSize(0.05);

  Overlays2->GetXaxis()->SetTitle("Electron ID Cuts");
  Overlays2->GetXaxis()->SetTitleSize(0.05);
  Overlays2->GetYaxis()->SetTitle("Sigma_{CB} (GeV)/c^{2}");
  Overlays2->GetYaxis()->SetTitleSize(0.05);

  Overlay1->SetLineColor(kBlack);
  Overlays2->SetLineColor(kBlue);
  ...
  leg->AddEntry(Overlay1, "2012 Data", "l");
...
void FillHistogram(TH1F *histo, RooWorkspace *w, Double_t bin) 
{
  ...
  histo->Fill(bin,sigma); 
  histo->SetBinError(bin,sigmaerror);
} // plotFitOn(..)
